...
В этой статье вы найдете упрощения и оптимизации характерные для каждодневного использования [API Scala коллекций](https://www.scala-lang.org/docu/files/collections-api/collections.html).
